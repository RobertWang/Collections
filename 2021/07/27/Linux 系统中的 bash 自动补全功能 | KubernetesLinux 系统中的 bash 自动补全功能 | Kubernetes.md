> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [v1-20.docs.kubernetes.io](https://v1-20.docs.kubernetes.io/zh/docs/tasks/tools/included/optional-kubectl-configs-bash-linux/)
