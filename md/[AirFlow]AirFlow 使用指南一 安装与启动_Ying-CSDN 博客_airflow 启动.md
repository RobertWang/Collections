> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [blog.csdn.net](https://blog.csdn.net/SunnyYoona/article/details/76592793)
...
运行上述命令之后，会在 $AIRFLOW_HOME 目录下生成如下文件:
