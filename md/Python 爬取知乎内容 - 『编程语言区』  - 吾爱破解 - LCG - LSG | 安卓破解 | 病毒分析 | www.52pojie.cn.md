> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [www.52pojie.cn](https://www.52pojie.cn/forum.php?mod=viewthread&tid=1460449&extra=page%3D1%26filter%3Dauthor%26orderby%3Ddateline) ![](https://avatar.52pojie.cn/data/avatar/000/47/64/11_avatar_middle.jpg)liuye  _ 本帖最后由 liuye 于 2021-6-18 22:04 编辑_  
题主的数据科学导论作业，关于舆情分析负责信息爬取。  
可能会对大家有点帮助，如果有哪写的不太好的地方，希望可以告诉我  
如果不想看，直接用的话把 js 代码命名为 **g_encrypt.js** 和 python 代码放在同一级目录就可以了（要搭建 nodejs 环境，具体可以参考 [Nodejs 安装及环境配置 - 简书 (jianshu.com)](https://www.jianshu.com/p/13f45e24b1de)）  
[size=13.0667px]  
...
    x_ab_pb = re.findall('encodedParams":"(.*?)"},"trigge', response, re.DOTALL)[0].replace("\\u002F","/")
    headers = {
...
![](https://www.52pojie.cn/uc_server/images/noavatar_middle.gif)dagon007  至今还没办法正常运行，需要 pip install 好几个模块。  
不知道哪里出错了，调试的时候告知是语法错误。  
已经将 js 文件放到同一个目录，然后名字也符合要求，但是发现似乎不行，后来在源代码强制改为绝对目录才可以继续往下运行，  
...
这几个在知乎的关键词。  
![](https://avatar.52pojie.cn/data/avatar/000/47/64/11_avatar_middle.jpg)liuye 

> [dagon007 发表于 2021-6-17 20:57](https://www.52pojie.cn/forum.php?mod=redirect&goto=findpost&pid=38953773&ptid=1460449)  
> 至今还没办法正常运行，需要 pip install 好几个模块。  
> 不知道哪里出错了，调试的时候告知是语法错误。  
> 已 ...

要搭建 nodejs 环境![](https://avatar.52pojie.cn/data/avatar/000/96/24/79_avatar_middle.jpg)王星星  谢谢分享！![](https://www.52pojie.cn/uc_server/images/noavatar_middle.gif)ELFENLIED  感谢分享 ![](https://avatar.52pojie.cn/data/avatar/000/21/95/95_avatar_middle.jpg) ying656 好东西  写的很好. 我都不会 js 用 python 还写不好 哈哈 谢谢你提供 ![](https://www.52pojie.cn/uc_server/images/noavatar_middle.gif) gentlespider 知乎现在不需要登录就 能 拿数据了嘛 - - 感觉我落伍好久了 ![](https://www.52pojie.cn/uc_server/images/noavatar_middle.gif) nastroy 大佬可以发下你用到的模块信息吗 ![](https://www.52pojie.cn/uc_server/images/noavatar_middle.gif) nastroy 

> [nastroy 发表于 2021-6-17 16:28](https://www.52pojie.cn/forum.php?mod=redirect&goto=findpost&pid=38951521&ptid=1460449)  
> 大佬可以发下你用到的模块信息吗

就是用到了那些模块。![](https://www.52pojie.cn/uc_server/images/noavatar_middle.gif)jhonsun  感谢分享！！！！！！！![](https://www.52pojie.cn/uc_server/images/noavatar_middle.gif)LSXG  很棒啊，拿了。![](https://www.52pojie.cn/uc_server/images/noavatar_middle.gif)729341299  涉及到环境问题，不说清楚 nodejs 环境搭建会遇到很多坑。