> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [www.ruanyifeng.com](https://www.ruanyifeng.com/blog/2023/08/weekly-issue-267.html)
...
我来科普一下，现有的互联网看电视，都是采用 **"一对一" 的模式，每个客户端需要单独的服务器信号发送**，100 个用户就需要 100 次发送，非常消耗带宽。
...
正因为 5G 广播电视有这么多优点，[美国](https://spectrum.ieee.org/5g-tv)和[欧洲](https://www.ibc.org/trends/5g-in-broadcast-5g-tv-online/5969.article)都在试验了。今年 5 月的英国国王查尔斯三世的加冕仪式，就同时用 5G 广播电视转播。
...
它的发电功率，据说可以达到 200 瓦 / 平方米。这已经跟同样面积的光伏板一样了。
...
这个仓库收集了全国 200 多所高校的校徽，制作成字体图标。（[@lovefc](https://github.com/ruanyf/weekly/issues/3362) 投稿）
...
2014 年 12 月，斯图尔特因病去世，享年 73 岁。该住宅公开出售，后来以 1.05 亿人民币的价格成交。
...
（6）10 倍程序员是一个愚蠢的神话。我只见过程序员将代码规模增加了 10 倍，最终结果是你必须修复 10 倍的 bug。

真正要做的不是找到神话中的 10 倍程序员，而是要避免出现 0.1 倍程序员。那些浪费时间、不寻求反馈、不测试代码、不考虑边缘情况等的程序员，必须保证让这样的人远离我们的团队。
...
哈佛大学的 GPA，20 世纪上半叶一直稳定在 2.5 左右，1960 年攀升至 3.0，今天已经涨到 3.8 了。
